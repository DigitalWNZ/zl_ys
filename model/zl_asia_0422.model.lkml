...
explore: htzx_asia_update {
  ...
  join: geo_ip_isp_mask {
    type: inner
    sql_on: NET.SAFE_IP_FROM_STRING(${htzx_asia_update.client_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
    relationship: many_to_one
  }
  # sql_always_where:
    ...
    explore: lz_net_dig_test_yh {
      ...
      explore: first_2_Hop {
        ...
        explore: gcp_hop {
          ...
          join: geo_ip_isp_mask {
            type: inner
            sql_on: NET.SAFE_IP_FROM_STRING(${gcp_hop.client_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
            relationship: many_to_one
          }
          # sql_always_where:
          #         (NET.SAFE_IP_FROM_STRING(${client_ip}) BETWEEN ${geo_ip_country_range.start_ip_byte} AND ${geo_ip_country_range.end_ip_byte})
...
explore: gcp_hop_dive_base {
  view_name: gcp_hop_dive
          ...
          explore: first_Hop{
            ...
            join: geo_ip_isp_mask {
              type: inner
              sql_on: NET.SAFE_IP_FROM_STRING(${first_Hop.client_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
              relationship: many_to_one
            }
          ...
          explore: second_Hop{
            ...
            join: geo_ip_isp_mask {
              type: inner
              sql_on: NET.SAFE_IP_FROM_STRING(${second_Hop.client_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
              relationship: many_to_one
            }
            # sql_always_where:(NET.SAFE_IP_FROM_STRING(${client_ip}) BETWEEN NET.SAFE_IP_FROM_STRING(${geo_ip_country_range.start_ip}) AND NET.SAFE_IP_FROM_STRING(${geo_ip_country_range.end_ip}))
            #   and (NET.SAFE_IP_FROM_STRING(${client_ip}) BETWEEN NET.SAFE_IP_FROM_STRING(${geo_ip_isp_range.start_ip}) AND NET.SAFE_IP_FROM_STRING(${geo_ip_isp_range.end_ip}));;
          ...
          explore: stat_from_cdn {
            ...
            join: geo_ip_isp_mask {
              type: inner
              sql_on: NET.SAFE_IP_FROM_STRING(${stat_from_cdn.remote_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
              relationship: many_to_one
            }
          ...
          explore: cdn_transform {
            ...
            join: geo_ip_isp_mask {
              type: inner
              sql_on: NET.SAFE_IP_FROM_STRING(${cdn_transform.remote_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
              relationship: many_to_one
            }
          ...
          explore: retention_interval {
            ...
            join: geo_ip_isp_mask {
              type: inner
              sql_on: NET.SAFE_IP_FROM_STRING(${retention_interval.remote_ip}) & NET.IP_NET_MASK(4, mask) = ${geo_ip_isp_mask.network_bin} and mask=${geo_ip_isp_mask.mask};;
              relationship: many_to_one
            }
