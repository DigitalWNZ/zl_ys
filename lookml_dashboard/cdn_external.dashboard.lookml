- dashboard: zl_asia_cdn
  ...
  - title: Client Heat Map
    ...
    explore: cdn_transform
    type: looker_map
    fields: [cdn_transform.count_distinct_remote_ip, geo_ip_country_range.country_iso_code]
  ...
  - title: Request by ASN
    ...
    explore: cdn_transform
    type: looker_pie
    fields: [cdn_transform.count, geo_ip_isp_range.asn]
    sorts: [cdn_transform.count desc]
    limit: 20
    query_timezone: UTC
    value_labels: legend
