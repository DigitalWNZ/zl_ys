- dashboard: zl_asia_1_0422
  ...
  - title: lost_rate_by_country
    ...
    fields: [geo_ip_country_mask.country_iso_code, lz_net_dig_test.lost_rate, lz_net_dig_test.timekey_30_time,
      geo_ip_country_mask.country_name]
    pivots: [geo_ip_country_mask.country_iso_code, geo_ip_country_mask.country_name]
    sorts: [geo_ip_country_mask.country_iso_code, lz_net_dig_test.timekey_30_time
        desc, geo_ip_country_mask.country_name]
    limit: 5000
    total: true
  ...
  - title: delay_gcp_hist
    ...
    pivots: [gcp_hop.asn_isp_peer_0422]
    fill_fields: [gcp_hop.delay_gcp_hist]
    sorts: [gcp_hop.delay_gcp_hist, gcp_hop.asn_isp_peer_0422]
    limit: 5000
  ...
  - title: pert95_by_country_v1
    ...
    fields: [lz_net_dig_test.timekey_30_time, geo_ip_country_mask.country_iso_code,
      geo_ip_country_mask.country_name, lz_net_dig_test.pert_95]
    pivots: [geo_ip_country_mask.country_iso_code, geo_ip_country_mask.country_name]
    sorts: [lz_net_dig_test.timekey_30_time desc, geo_ip_country_mask.country_iso_code,
      geo_ip_country_mask.country_name]
    limit: 500
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: pert80_by_country_v1
    ...
    type: looker_line
    fields: [lz_net_dig_test.timekey_30_time, geo_ip_country_mask.country_iso_code,
      lz_net_dig_test.pert_80, geo_ip_country_mask.country_name]
    pivots: [geo_ip_country_mask.country_iso_code, geo_ip_country_mask.country_name]
    sorts: [lz_net_dig_test.timekey_30_time desc, geo_ip_country_mask.country_iso_code,
      geo_ip_country_mask.country_name]
    limit: 500
  ...
  - title: First Hop Delay
    ...
    sorts: [first_Hop.delay0_hist, geo_ip_isp_mask.isp]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: Second Hop Delay
    ...
    sorts: [second_Hop.delay1_hist, geo_ip_isp_mask.isp]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: ping_interval_by_isp
    ...
    sorts: [geo_ip_isp_mask.isp 0, lz_net_dig_test.average_interval]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: ping_interval_by_country
    ...
    fill_fields: [lz_net_dig_test.average_interval]
    sorts: [geo_ip_country_mask.country_iso_code 0, lz_net_dig_test.average_interval]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
